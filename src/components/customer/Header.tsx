    ...
    <header className="bg-white shadow-sm">
      <div className="container-section py-4 flex flex-col gap-4">
        <div className="flex flex-wrap items-center justify-between gap-3 md:gap-5">
          ...
          <div className="w-full md:flex-1 md:max-w-[620px] flex items-stretch">
            <input
              type="text"
              ...
              className="flex-1 rounded-l-md border border-gray-300 px-3 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#0f5c5c]"
            />
            <button
              type="button"
          ...
          <button
            ...
            className="sm:hidden inline-flex items-center justify-center h-10 w-10 rounded-md border border-gray-300 text-gray-700"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
